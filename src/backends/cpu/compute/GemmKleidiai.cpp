...
static bool kleidiai_is_i8mm_supported() {
...
static KleidiaiQsi4Tile kleidiai_get_best_qsi4_tile_config() {
    ...
    static const KleidiaiQsi4Tile best_tile = kleidiai_is_i8mm_supported() ?
